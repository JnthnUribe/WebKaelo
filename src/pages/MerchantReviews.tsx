...
const reviews = [
  { id: "mr1", userName: "Ana García", avatar: "https://i.pravatar.cc/40?img=5", rating: 5, comment: "Excelente café y atención al ciclista. Los kits energéticos son lo mejor.", date: "2026-02-16" },
  ...
  { id: "mr3", userName: "Laura Pech", avatar: "https://i.pravatar.cc/40?img=20", rating: 5, comment: "¡Mi parada favorita! La horchata con coco es increíble.", date: "2026-02-08" },
          ...
          {distribution.map((stars, i) => (
            <div key={stars} className="flex items-center gap-2 text-sm">
              ...
              <div className="flex-1 h-2 bg-muted rounded-full">
                <div className="h-2 bg-rating rounded-full transition-all" style={{ width: `${(counts[i] / total) * 100}%` }} />
              </div>
